<div class="m-auto w-1/2">
    ...
    <form wire:submit="save">
        ...
        <div class="mb-3">
            ...
            <input type="text" class=" p-4 w-full border rounded-md bg-gray-700 text-white" wire:model="form.title">
            <div>
                @error('title')
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                <label class="flex items-center">
                    <input type="checkbox" name="publish" class="mr-2" wire:model.boolean="publish">
                    Published
                </label>
            </div>
            <div class="mb-3">
